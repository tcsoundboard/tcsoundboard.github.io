	...
	constructor(props) {
		...
		this.state = {
	  	sounds: [
            ...
            { id: 16, soundName: 'NOW I AM BECOME DEATH (DROP)', soundURL: './sounds/nowiambecomedeath.mp3', isPlaying: false, isNew: true },
            { id: 17, soundName: 'NEW YORK NEWS (DROP)', soundURL: './sounds/newyorknews.mp3', isPlaying: false, isNew: true },
            { id: 18, soundName: 'TIME CRISIS ENEMIES (DROP)', soundURL: './sounds/tcenemies.mp3', isPlaying: false, isNew: true },
            { id: 19, soundName: 'THIS IS YOUR SONG (DROP)', soundURL: './sounds/thisisyoursong.mp3', isPlaying: false, isNew: true },
            { id: 20, soundName: 'LOVE, I DON\'T GET ENOUGH OF IT (DROP)', soundURL: './sounds/loveidontgetenoughofit.mp3', isPlaying: false, isNew: true },
            ...
            { id: 46, soundName: 'KIND VIBE', soundURL: './sounds/kindvibe.mp3', isPlaying: false, isNew: true },
